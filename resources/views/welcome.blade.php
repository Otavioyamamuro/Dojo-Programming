...
<body>
        ...
        <div class="container div-header">
            ...
            <div class="items-header">
                ...
                <div class="div-pesquisa">
                    <input type="number" id="busca" min="0" placeholder="Pesquisar">
                    <button id="btnbusca">
    ...
    <main class="container">
        <div class="div-cards">
            <section class="card" id='carro-1'>
                <div class="info">
                <label>Marca</label>
                <label>Modelo</label>
            </div>
                <div class="div-button">
                    <button onclick="fnExcluir(1)">
                    ...
                    <input type='hidden' class='id-btn' id="1">
                    <button onclick="fnEditar('Marca','Modelo',1)">
